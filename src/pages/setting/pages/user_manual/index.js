    ...
    <View className={`pd-lr-20 user-manual theme-${user.theme}`}>
      <View className='flex-col mg-tb-20'>
        ...
        <View className='flex-col gray-500 mg-b-20'>
          ...
          <View className='mg-t-10'>空气质量：点击进入可以查看空气质量实况详情以及周围的监测站点在地图上的空气质量监测数值以及全国城市AQI排行榜TOP10。
            在空气详情页点击AQI预报，可以查看24小时逐时预报和未来5天逐天预报，统计图面积越红空气质量越差，越绿空气质量越好。
            排行榜更多点击进入默认展示全国城市AQI排行榜，可以通过搜索查询你想要查询的城市AQI。</View>
        </View>
        <View className='flex-col gray-500 mg-b-20'>
